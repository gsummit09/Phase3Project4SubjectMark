...
namespace Phase3AssistedPractice_4.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MarksController : ControllerBase
    {
        private readonly MarksDbContext _context;

        public MarksController(MarksDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Marks>> PostMarks(Marks marks)
        {
          if (_context.Marks == null)
          {
              return Problem("Entity set 'MarksDbContext.Marks'  is null.");
          }
